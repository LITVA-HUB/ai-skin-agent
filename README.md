...
## Что покрыто тестами
- health endpoint
- analyze + follow-up (makeup)
- exclude-ingredient follow-up
- compare mode (intent + категории)
- explain mode по категории
- hybrid domain analyze (skincare + makeup)
- retrieval: hybrid план, tone/undertone/finish, дешевле, replacement
- UI root page

## Ограничения
- shade match по фото всё ещё приблизительный
- бренды/ингредиенты ловятся эвристически, без полноценного NER
