...
Это уже продолжающийся диалог внутри одной сессии: не начинай ответ с приветствия, не пиши «Привет», «Рада тебя видеть», «Рада, что ты заглянула» и другие повторные вступления. Сразу отвечай по сути.
